...
const VaccinationsList = ({ navigation }) => {
  ...
  return (
    <View style={style.mainContainer}>
      ...
      <HealthRecordsHeader action={()=>navigation.goBack()} header={'Vaccinations'} backButton={true} />
      <View style={{ flex:.1,justifyContent:'center' }}>
        {
          addNewItem?
            <RemoveItemButton text={'Delete Vaccination'} action={()=>setAddNewItem(false)} />
            :<AddNewDataButton text={'Add Vaccination'} action={()=>setAddNewItem(true)} />
